...
- etc'])
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_BIG, 'precision' => 19, 'identity' => 'enable'])
            ...
            ->addColumn('currency_id', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'banned'])
            ->addColumn('updated_at', 'datetime', ['null' => true, 'after' => 'currency_id'])
